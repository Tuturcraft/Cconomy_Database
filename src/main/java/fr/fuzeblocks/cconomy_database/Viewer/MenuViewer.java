...
public class MenuViewer  {
    public static void loadMenu(Player player) {
        ...
        try {
            manager.setItem(ItemFactory.CreateItemStack(Material.PAPER, config.getColor(LanguageManager.getKey() + "PaperofMoney") + String.valueOf(getMoney(getConnection(),player.getUniqueId()))),4);
